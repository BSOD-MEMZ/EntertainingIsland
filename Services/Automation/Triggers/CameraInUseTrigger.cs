...
[TriggerInfo("entertainingisland.camera.in-use", "摄像头被使用时", "\uE392")]
public class CameraInUseTrigger : TriggerBase
{
    ...
    {
        if (e.PropertyName == nameof(CameraMonitorService.IsCameraInUse) && _service?.IsCameraInUse == true)
            Trigger();
    }
}
